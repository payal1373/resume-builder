...
class Experience extends Component {
  ...
  createAndDownloadPDF = () => {
    axios
      .post ('https://resume-builder-payal.herokuapp.com/create-pdf', this.props.values)
      .then (() => {
        axios
          .get ('https://resume-builder-payal.herokuapp.com/fetch-pdf', {responseType: 'arraybuffer'})
          .then (res => {
